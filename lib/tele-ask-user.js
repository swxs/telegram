...
export function registerTelegramSessionHint(agentCtx) {
    const scoped = agentCtx;
    const systemPrompt = scoped.systemPrompt ?? agentCtx.get('systemPrompt');
...
export function wireTeleAskUserTool(agentCtx, bridge) {
